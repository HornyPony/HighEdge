class ItemsDropdown {
  static final List<String> regionsItems = [
    "Алтайский край",
    "Амурская область",
  ...
  static final List<String> tatarstanCities = [
    "Абалачи",
    "Абди",
    "Абдрахманово",
    "Абсалямово",
  ...
  static final List<String> kazanSchools = [
    'Школа №1',
    'Школа №2',
    'Школа №3',
  ];

  static final List<String> classroomTeachers = [
    'Хатипова Наталья Ивановна',
    'Борисов Сергей Евгеньевич',
    'Цой Ирина Викторовна',
  ];
}
